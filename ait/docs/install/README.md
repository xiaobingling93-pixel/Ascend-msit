...
| ATB | 非必选 | -    | 依赖加速库ATB，需按照[MindIE-LLM](https://gitee.com/ascend/MindIE-LLM)说明安装加速库ATB工具。(如不使用ait llm dump、opcheck、errcheck等功能则不需要安装)                                                                       |
| MindIE-LLM | 非必选 | -    | 依赖MindIE-LLM组件，需按照[MindIE-LLM](https://gitee.com/ascend/MindIE-LLM)说明安装MindIE-LLM。(如不使用ait llm dump、opcheck、errcheck等功能则不需要安装)                                                               |
