...
# ChatGLM-6B 使用示例
- 使用前安装msit工具，参考 [msit 工具安装](https://gitee.com/ascend/msit/blob/master/msit/docs/install/README.md)，`ChatGLM-6B` 模型定义位于加速库下的 `pytorch/examples/chatglm6b/modeling_chatglm_model_310p.py`
