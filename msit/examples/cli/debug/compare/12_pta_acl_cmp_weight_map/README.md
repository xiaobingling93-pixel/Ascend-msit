...
# ChatGLM-6B 使用示例
- 使用前安装msit工具，参考 [msit 工具安装](https://gitee.com/ascend/msit/blob/master/msit/docs/install/README.md)，`ChatGLM-6B` 模型定义位于加速库下的 `pytorch/examples/chatglm6b/modeling_chatglm_model_xxxyy.py`，xxxyy为用户实际使用的具体芯片类型
...
# BLOOM-7B 使用示例
- 使用前安装msit工具，参考 [msit 工具安装](https://gitee.com/ascend/msit/blob/master/msit/docs/install/README.md)，`BLOOM-7B` 模型定义位于加速库下的 `pytorch/examples/bloom7b`
