...
3. 目前msit convert aie命令支持以下4个模型：
...
结果输出如下：
```shell
[INFO] Execute command:['./msit_convert', 'resnet50.onnx', 'resnet50.om', 'Ascend310P3']
[INFO] AIE model convert finished, the command: ['./msit_convert', 'resnet50.onnx', 'resnet50.om', 'Ascend310P3']
