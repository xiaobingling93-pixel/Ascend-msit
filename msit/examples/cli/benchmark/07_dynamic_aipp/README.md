...
#### benchmark命令
```
msit benchmark --model resnet18_bs4_dym_aipp.om --aipp_config actual_aipp_conf.config
```
...
#### benchmark命令
```
msit benchmark --model resnet18_dym_batch_aipp.om --aipp_config actual_aipp_conf.config --dymBatch 1
```
...
#### benchmark命令
```
msit benchmark --model resnet18_dym_image_aipp.om --aipp_config actual_aipp_conf.config --dymHW 112,112
```
