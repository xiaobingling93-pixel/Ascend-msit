...
class NpuTfAdapterDumpData(object):
    ...
    def get_model_inputs_dtype(model_path, serving, tag_set):
        ...
        with tf.compat.v1.Session() as sess:
            tag_set = tf.compat.v1.saved_model.tag_constants.SERVING if not tag_set else tag_set
    ...
    def generate_dump_data(self):
        ...
        with tf.compat.v1.Session(config=config_proto) as sess:
            tag_set = tf.compat.v1.saved_model.tag_constants.SERVING if not self.tag_set else self.tag_set
