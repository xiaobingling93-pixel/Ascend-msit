...
| 参数名                      | 描述                                                                                                                                                                                                             | 必选   |
| ------------------------ |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| ---- |
| -m，--model-path          | 模型文件（.pb或.onnx)路径，目前只支持pb模型与onnx模型，TF2.6.5版本支持saved_model模型                                                                                                                                                    | 是    |
| -om，--offline-model-path | 昇腾AI处理器的离线模型（.om），TF2.6.5版本支持输入saved_model模型在NPU上与其在GPU上的精度比对                                                                                                                                                  | 是    |
