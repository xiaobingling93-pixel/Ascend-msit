...
from components.profile.msprof.ait_prof.msprof_process import (
...
class TestMsprofUtils(unittest.TestCase):
    ...
    @patch('components.profile.msprof.ait_prof.msprof_process.args_rules')
    @patch('shutil.which')
    @patch('os.getenv')
    @patch('components.profile.msprof.ait_prof.msprof_process.msprof_run_profiling')
