...
MIXED_SPECULATIVE_MOE_AL = [AlgorithmType.SPECULATIVE_MOE_LEVEL_1_MIXED, AlgorithmType.SPECULATIVE_MOE_LEVEL_2_MIXED]
LEVEL_1_SPECULATIVE_MOE_AL = [AlgorithmType.SPECULATIVE_MOE_LEVEL_1, AlgorithmType.SPECULATIVE_MOE_LEVEL_1_MIXED]
LEVEL_2_SPECULATIVE_MOE_AL = [AlgorithmType.SPECULATIVE_MOE_LEVEL_2, AlgorithmType.SPECULATIVE_MOE_LEVEL_2_MIXED]
