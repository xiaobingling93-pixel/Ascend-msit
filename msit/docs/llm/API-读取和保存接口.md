...
|----|
|1<td rowspan='6'>tool.py</td><td rowspan='1'>获取bin文件集合</td><td rowspan='1'>[get_bin_data_from_dir](#get_bin_data_from_dir)</td>|
|2<td rowspan='1'>读取bin文件</td><td rowspan='1'>[read_bin_data](#read_bin_data)</td>|
|3<td rowspan='2'>转换bin文件</td><td rowspan='1'>[convert_bin_data_to_pt](#convert_bin_data_to_pt)</td>|
|4<td rowspan='1'>[convert_bin_data_to_npy](#convert_bin_data_to_npy)</td>|
|5<td rowspan='2'>保存文件</td><td rowspan='1'>[save_torch_data](#save_torch_data)</td>|
|6<td rowspan='1'>[save_npy_data](#save_npy_data)</td>|
