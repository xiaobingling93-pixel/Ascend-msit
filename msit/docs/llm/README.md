...
#### 工具列表
> * [BadCase分析使用说明](/msit/docs/llm/工具-BadCase分析使用说明.md)
...
> * [加速库场景-手动映射比对能力说明](/msit/docs/llm/加速库场景-手动映射比对能力说明.md)
...
1. 定位存在精度问题的输入
   1. **Bad Case 分析**: 当数据集评估不理想，需要找到存在精度问题的Bad Case ,可以通过 [**BadCase分析使用说明**](/msit/docs/llm/工具-BadCase分析使用说明.md) 定位。
