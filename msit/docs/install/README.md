...
| ATB | 非必选 | 支持1.0.RC3和1.0.0，与mindie-llm版本对应即可                                                                             | 依赖加速库ATB，推荐使用mindie镜像（包含ATB、MindIE-LLM、MindIE-Service等部件），外部客户获取请参考[MindIE镜像](https://www.hiascend.com/developer/ascendhub/detail/af85b724a7e5469ebd7ea13c3439d48f)，安装所需版本mindie镜像即可，内部客户手动编译可按照[MindIE-LLM](https://gitee.com/ascend/MindIE-LLM)说明安装加速库ATB工具。(如不使用msit llm dump、opcheck、errcheck等功能则不需要安装)                                                                                                        |
