...
| ATB | 非必选 | 与MindIE-LLM版本配套即可                                                                             | 依赖加速库ATB，推荐使用MindIE镜像（包含ATB、MindIE-LLM、MindIE-Service等部件），镜像获取链接请参考[MindIE镜像](https://www.hiascend.com/developer/ascendhub/detail/af85b724a7e5469ebd7ea13c3439d48f)，安装所需版本MindIE镜像即可。也可以通过源码的方式编译安装，参考[MindIE-LLM](https://gitee.com/ascend/MindIE-LLM)说明安装加速库ATB工具, 注意需要申请加入Ascend组织后才可以查看该代码仓。(如不使用msit llm dump、opcheck、errcheck等功能则不需要安装)                                                                                                        |
| MindIE-LLM | 非必选 | 支持1.0.RC3和1.0.0，分别与CANN包版本8.0.RC1和8.0.RC2对应                                                                   | 依赖MindIE-LLM组件，推荐使用MindIE镜像（包含ATB、MindIE-LLM、MindIE-Service等部件），镜像获取链接请参考[MindIE镜像](https://www.hiascend.com/developer/ascendhub/detail/af85b724a7e5469ebd7ea13c3439d48f)，安装所需版本MindIE镜像即可。也可以通过源码的方式编译安装，参考[MindIE-LLM](https://gitee.com/ascend/MindIE-LLM)说明安装MindIE-LLM，注意需要申请加入Ascend组织后才可以查看该代码仓。(如不使用msit llm dump、opcheck、errcheck等功能则不需要安装)                                                                                                |
