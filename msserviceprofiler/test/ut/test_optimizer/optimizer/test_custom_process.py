...
@patch("msserviceprofiler.modelevalstate.optimizer.custom_process.kill_process")
...
@patch('msserviceprofiler.modelevalstate.optimizer.custom_process.CustomProcess.kill_residual_process')
@patch('msserviceprofiler.modelevalstate.optimizer.custom_process.CustomProcess.before_run')
@patch('msserviceprofiler.modelevalstate.optimizer.custom_process.subprocess.Popen')
