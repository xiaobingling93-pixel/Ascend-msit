...
class TestStateParam(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(param.ohe_path, Path("/tmp/test/ohe"))
    ...
    def test_default_initialization(self):
        ...
        self.assertTrue(sp.ohe_path.exists())
    ...
    def test_serialization(self):
        ...
        self.assertEqual(deserialized.title, sp.title)
        self.assertEqual(deserialized.base_path, sp.base_path)
        self.assertEqual(deserialized.predict_field, sp.predict_field)
