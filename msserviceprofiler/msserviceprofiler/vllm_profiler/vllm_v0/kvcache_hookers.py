...
@vllm_hook(hook_points=("vllm.core.block_manager", "SelfAttnBlockSpaceManager.allocate"), min_version="0.6.3")
...
@vllm_hook(hook_points=("vllm.core.block_manager", "SelfAttnBlockSpaceManager.append_slots"), min_version="0.6.3")
...
@vllm_hook(hook_points=("vllm.core.block_manager", "SelfAttnBlockSpaceManager.swap_in"), min_version="0.6.3")
...
@vllm_hook(hook_points=("vllm.core.block_manager", "SelfAttnBlockSpaceManager.swap_out"), min_version="0.6.3")
...
@vllm_hook(hook_points=("vllm.core.block_manager", "SelfAttnBlockSpaceManager.free"), min_version="0.6.3")
...
@vllm_hook(hook_points=("vllm.engine.llm_engine", "LLMEngine._get_stats"), min_version="0.6.3")
