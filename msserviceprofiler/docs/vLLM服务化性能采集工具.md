...
- 其他环境依赖查看[版本说明和要求](https://support.huaweicloud.com/bestpractice-modelarts/modelarts_llm_infer_91203.html) 和 [vLLM Ascend](https://vllm-ascend.readthedocs.io/en/latest/)
