...
1. 访问["OBS 制品仓"](https://www.openlibing.com/apps/obsArtifactRepository)，单击 "ascend-package" > "msit"。
   ![download msit package on openlibing website](./figures/download_msit_package.png)
2. 单击["下载"](https://ascend-package.obs.cn-north-4.myhuaweicloud.com/msit/Ascend-mindstudio-inference-toolkit_linux-x86_64.run)，将软件包下载至本地
3. 在终端通过`wget`进行下载。
