...
if __name__ == "__main__":
    ...
    get_valid_read_path(args.ae_path, is_dir=True)
    get_valid_read_path(args.text_encoder_name, is_dir=True)
    get_valid_read_path(args.model_path, is_dir=True)
    get_write_directory(args.cache_dir)
