...
def main():
    ...
    copy_config_files(input_path=args.model_path, output_path=save_path, quant_config=quant_config,
                      custom_hooks=custom_hooks)
    pbar.update(1)
    add_safetensors(org_paths=args.model_path, target_dir=save_path, safetensors_prefix="mtp_float",
