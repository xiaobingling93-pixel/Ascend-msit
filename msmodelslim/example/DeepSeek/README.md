...
- ![img_1.png](img_1.png)
- 4、修改quant_deepseek_w8a8.py脚本，增加卡数，eg: max_memory={0: "50GiB", 1: "50GiB", "cpu": "1500GiB"},
  可以根据自己的卡数以及显存情况设置，以防OOM显存不够报错。
- ![img_2.png](img_2.png)
...
- ![img_1.png](img_1.png)
- Q: 遇到OOM显存不够报错
- A：修改quant_deepseek_w8a8.py脚本，增加卡数，eg: max_memory={0: "50GiB", 1: "50GiB", "cpu": "1500GiB"},
  可以根据自己的卡数以及显存情况设置。
- ![img_2.png](img_2.png)