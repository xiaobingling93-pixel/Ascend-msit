...
## 功能指南
msModelSlim V0量化服务基于旧版msModelSlim量化框架及其Python API 接口实现量化功能，将量化过程分为模型加载、离群值抑制和量化校准三个阶段，可以在离群值抑制和量化校准阶段分别采用一种算法。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      <a href="./接口说明/Python-API接口说明/剪枝接口/PruneTorch/__init__.md">__init__</a>
...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="8"><strong>大语言模型</strong></td>
      <td>DeepSeek</td>
      <td><a href="../example/DeepSeek/README.md">DeepSeek 量化推荐实践</a></td>
    </tr>
    <tr>
      <td>Qwen3-MoE</td>
      <td><a href="../example/Qwen3-MOE/README.md">Qwen3-MoE 量化推荐实践</a></td>
    </tr>
    <tr>
      <td>Qwen</td>
      <td><a href="../example/Qwen/README.md">Qwen 量化推荐实践</a></td>
    </tr>
    <tr>
      <td>Llama</td>
      <td><a href="../example/Llama/README.md">Llama 量化推荐实践</a></td>
    </tr>
    <tr>
      <td>GLM</td>
      <td><a href="../example/GLM/README.md">GLM 量化推荐实践</a></td>
    </tr>
    <tr>
      <td>GPT-NeoX</td>
      <td><a href="../example/GPT-NeoX/README.md">GPT-NeoX 量化推荐实践</a></td>
    </tr>
    <tr>
      <td>HunYuan</td>
      <td><a href="../example/HunYuan/README.md">HunYuan 量化推荐实践</a></td>
    </tr>
    <tr>
      <td>InternLM2</td>
      <td><a href="../example/InternLM2/README.md">InternLM2 量化推荐实践</a></td>
    </tr>
    <tr>
      <td rowspan="5"><strong>多模态理解模型</strong></td>
      <td>Qwen2.5-VL</td>
      <td><a href="../example/Qwen2.5-VL/README.md">Qwen2.5-VL 量化推荐实践</a></td>
    </tr>
    <tr>
      <td>Qwen2-VL</td>
      <td><a href="../example/Qwen2-VL/README.md">Qwen2-VL 量化推荐实践</a></td>
    </tr>
    <tr>
      <td>InternVL2</td>
      <td><a href="../example/InternVL2/README.md">InternVL2 量化推荐实践</a></td>
    </tr>
    <tr>
      <td>Llava</td>
      <td><a href="../example/Llava/README.md">Llava 量化推荐实践</a></td>
    </tr>
    <tr>
      <td>Qwen-VL</td>
      <td><a href="../example/Qwen-VL/README.md">Qwen-VL 量化推荐实践</a></td>
    </tr>
    <tr>
      <td rowspan="2"><strong>多模态生成模型</strong></td>
      <td>multimodal_sd</td>
      <td><a href="../example/multimodal_sd/README.md">多模态生成模型量化推荐实践</a></td>
    </tr>
    <tr>
      <td>OpenSoraPlan V1.2</td>
      <td><a href="../example/osp1_2/README.md">OpenSoraPlan V1.2 推理优化推荐实践</a></td>
    </tr>
  </tbody>
</table>
