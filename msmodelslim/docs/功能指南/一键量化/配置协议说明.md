...
该配置文件描述了使用V1量化服务的基础配置框架，process和save字段为空，表示未配置任何处理流程和保存操作。
...
- 稠密模型W8A8动态量化：[dense-w8a8-dynamic-v1.yaml](./example/dense-w8a8-dynamic-v1.yaml)
- 稠密模型W8A8静态量化：[dense-w8a8-v1.yaml](./example/dense-w8a8-v1.yaml)
- 稀疏模型W8A8混合量化：[moe-w8a8-mix-v1.yaml](./example/moe-w8a8-mix-v1.yaml)
