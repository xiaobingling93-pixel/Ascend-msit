...
from msmodelslim.model.qwen2_5 import Qwen25ModelAdapter
...
class TestQwen25ModelAdapter(unittest.TestCase):
    ...
    def test_get_model_type(self):
        """测试get_model_type方法"""
        with patch('msmodelslim.model.qwen2_5.TransformersModel.__init__', return_value=None):
    ...
    def test_load_tokenizer(self):
        ...
        with patch('msmodelslim.model.qwen2_5.TransformersModel.__init__', return_value=None):
            ...
            with patch('msmodelslim.model.qwen2_5.SafeGenerator.get_tokenizer_from_pretrained') as mock_get_tokenizer:
