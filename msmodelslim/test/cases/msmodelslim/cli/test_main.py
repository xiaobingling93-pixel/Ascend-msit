...
# 设置模拟模块的属性
mock_modules['msmodelslim.infra.practice_manager'].SUPPRORTED_QUANT_TYPES = ['w8a8', 'w4a8']
mock_modules['msmodelslim.utils.safe_utils'].cmd_bool = lambda x: x.lower() == 'true'
...
# 现在可以安全地导入main模块
from msmodelslim.cli.__main__ import main, MIND_STUDIO_LOGO, FAQ_HOME
...
class TestMainCLI:
    ...
    def setup_method(self):
        ...
        self.main_module = importlib.import_module('msmodelslim.cli.__main__')
    ...
    def test_quant_command_valid_args(self):
        ...
        3. 命令正确分发到quant_main
        """
        mock_quant = mock_modules['msmodelslim.cli.naive_quant.naive_quant']
