...
from msmodelslim.app.quant_service.modelslim_v1.save.mindie_format import (
...
class TestMindIEFormatSaver:
    ...
    def test_mindie_format_saver_initialization(self, mock_model, mock_config, mock_adapter):
        ...
        with patch(
                'msmodelslim.app.quant_service.modelslim_v1.save.mindie_format.dist.is_initialized') as mock_dist_init:
    ...
    def test_mindie_format_saver_get_safetensors_writer_with_part_file_size_positive(self, mock_model, mock_config,
        ...
        with patch(
                'msmodelslim.app.quant_service.modelslim_v1.save.mindie_format.BufferedSafetensorsWriter') as mock_buffered_writer_class:
            mock_writer = Mock()
    ...
    def test_mindie_format_saver_get_safetensors_writer_with_part_file_size_zero(self, mock_model, mock_config,
        ...
        with patch(
                'msmodelslim.app.quant_service.modelslim_v1.save.mindie_format.SafetensorsWriter') as mock_safetensors_writer_class:
            mock_writer = Mock()
    ...
    def test_mindie_format_saver_get_rank_save_directory(self, mock_model, mock_config, mock_adapter):
        ...
        with patch(
            ...
            with patch('msmodelslim.app.quant_service.modelslim_v1.save.mindie_format.dist.get_rank') as mock_get_rank:
    ...
    def test_mindie_format_saver_preprocess_with_distributed(self, mock_model, mock_config, mock_adapter,
        ...
        with patch(
                'msmodelslim.app.quant_service.modelslim_v1.save.mindie_format.DistHelper') as mock_dist_helper_class:
...
class TestMindIEFormatSaverModuleHandlers:
    ...
    def test_on_w8a8_static_with_bias(
        ...
        # 1. Mock分布式未初始化
        with patch(
                "msmodelslim.app.quant_service.modelslim_v1.save.mindie_format.dist.is_initialized"
        ) as mock_dist_init:
            mock_dist_init.return_value = False
    ...
    def test_mindie_format_saver_on_w8a8_dynamic(self, mock_model, mock_config, mock_adapter):
        ...
        with patch(
            ...
            with patch(
                    'msmodelslim.app.quant_service.modelslim_v1.save.mindie_format.torch.device') as mock_torch_device:
