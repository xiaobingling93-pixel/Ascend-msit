...
from msmodelslim.app.quant_service.multimodal_vlm_v1.quant_service import (
...
class TestMultimodalVLMModelslimV1QuantService:
    ...
    @patch("msmodelslim.app.quant_service.multimodal_vlm_v1.quant_service.get_logger")
    ...
    @patch("msmodelslim.app.quant_service.multimodal_vlm_v1.quant_service.get_logger")
    @patch("msmodelslim.app.quant_service.multimodal_vlm_v1.quant_service.LayerWiseRunner")
    @patch("msmodelslim.app.quant_service.multimodal_vlm_v1.quant_service.torch")
    @patch("msmodelslim.app.quant_service.multimodal_vlm_v1.quant_service.seed_all")
