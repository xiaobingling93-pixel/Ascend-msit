...
print("[PyTorch] Original model parameters: ", model_param)
...
print("[PyTorch] After decomposition, model parameters: ", new_model_param)
...
print("[MindSpore] Origin model parameters: ", lrd_model_param)
...
print("[MindSpore] After decomposition, model parameters: ", new_lrd_model_param)
...
new_resnet50 = decomposer.decompose_network(do_decompose_weight=True)
new_model_param = count_parameters(new_resnet50)
print("[MindSpore] After decomposition, model parameters: ", new_model_param)
