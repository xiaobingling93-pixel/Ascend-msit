...
from msmodelslim.quant.ir import int8_per_token_sym, int8_per_channel_sym, AutoFakeQuantLinear, int8_per_group_sym
from msmodelslim.quant.ir.const import int8_per_group_asym
...
@logger_setter('msmodelslim.quant.ir.w8a8_dynamic_per_group')
