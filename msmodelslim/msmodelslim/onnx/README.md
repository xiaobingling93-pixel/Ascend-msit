...
[表格1 已验证模型列表（Atlas A2训练系列产品/Atlas 800I A2推理产品或Atlas 推理系列产品）](msmodelslim/docs/onnx验证表格1.xlsx)

[表格2 已验证模型列表（Atlas 200/500 A2推理产品）](msmodelslim/docs/onnx验证表格2.xlsx)