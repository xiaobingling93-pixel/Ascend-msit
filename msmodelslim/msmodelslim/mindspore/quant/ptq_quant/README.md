...
### 操作步骤
1. 用户自行准备预训练模型和数据集。本样例以 ResNet50为例，获取模型结构定义脚本，并参考README下载所需数据集， 以cifar10为例，在config/resnet50_cifar10_config.yaml里配置data_path和checkpoint_file_path，并在eval.py的基础上进行修改。
