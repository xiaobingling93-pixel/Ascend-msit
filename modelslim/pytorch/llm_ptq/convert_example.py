...
class MSModelSlimWeightProcessor:
    def __init__(self, weight):
        ...
        self.QuantType = 'W8A16'  # 示例量化权重的量化类型，请根据实际修改
        self.modelslim_description_json['model_quant_type'] = self.QuantType
    ...
    def weight_process(self):
        ...
        for key in linear_list:
            ...
            self.modelslim_description_json[weight_key] = self.QuantType
    ...
    def anti_outlier_process(self):
        ...
        for key in norm_list:
            ...
            self.modelslim_description_json[msmodelslim_norm_module_bias_key] = self.QuantType
